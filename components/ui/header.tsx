...
export function Header() {
  return <div className="w-full fixed top-0 left-0 p-4 flex justify-center items-center z-10000 py-8">
    <div className="w-10/12 flex items-center justify-between">
      ...
      <nav className="bg-black/30 backdrop-blur-2xl p-2 px-3 border border-gray-700 rounded-xl flex gap-7 text-xl text-white">
        ...
        <Link className="p-1 rounded-xl hover:bg-black duration-200 px-3" href={'/products'}>Products</Link>
        <Link className="p-1 rounded-xl hover:bg-black duration-200 px-3" href={'/app'}>Community</Link>
      </nav>
    </div>
  </div>
}